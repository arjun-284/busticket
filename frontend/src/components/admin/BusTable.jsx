            ...
            {buses.length > 0 ? (
              buses.map((bus, index) => (
                <tr key={bus._id}>
                  ...
                  {/* Fix: Show name if from/to is object, else show value */}
                  <td className="border border-gray-300 px-4 py-2">
                    {bus.from && typeof bus.from === 'object' ? bus.from.name : bus.from}
                  </td>
                  <td className="border border-gray-300 px-4 py-2">
                    {bus.to && typeof bus.to === 'object' ? bus.to.name : bus.to}
                  </td>
